 ...
 * Generated for Laravel 5.3.31 on 2021-06-20.
 *
...
namespace App\API\Sms { 
    ...
    class Sms {
         ...
         * @static 
         */ 
        public static function store($storeType = 'default')
        {
            return \App\API\Sms\SmsManager::store($storeType);
        }
        ...
        public static function repository($store)
        {
            return \App\API\Sms\SmsManager::repository($store);
        }
        ...
        {
            return \App\API\Sms\SmsManager::getDefaultStore();
        }
         ...
         * @static 
         */ 
        public static function getConfig($provider, $storeType, $currentSmsProvider)
        {
            return \App\API\Sms\SmsManager::getConfig($provider, $storeType, $currentSmsProvider);
        }
...
namespace App\API\Ivr { 
    ...
    class Ivr {
        ...
        public static function store($name = null)
        {
            return \App\API\Ivr\IvrManager::store($name);
        }
        ...
        public static function repository($store)
        {
            return \App\API\Ivr\IvrManager::repository($store);
        }
        ...
        public static function getDefaultStore()
        {
            return \App\API\Ivr\IvrManager::getDefaultStore();
        }
        ...
        {
            return \App\API\Ivr\IvrManager::getConfig($name);
        }
...
namespace App\API\CustomPdf\LaravelPdf\Facades { 
    ...
    class Pdf {
         ...
         *
         * @param string $html
         * @return \App\API\CustomPdf\LaravelPdf\Pdf 
         * @static 
         */ 
        public static function loadHTML($html, $config = array())
        {
            return \App\API\CustomPdf\LaravelPdf\PdfWrapper::loadHTML($html, $config);
        }
        ...
        {
            return \App\API\CustomPdf\LaravelPdf\PdfWrapper::loadFile($file, $config);
        }
        ...
        {
            return \App\API\CustomPdf\LaravelPdf\PdfWrapper::loadView($view, $data, $mergeData, $config);
        }
...
namespace  { 
    ...
    class Sms extends \App\API\Sms\Sms {}

    class Ivr extends \App\API\Ivr\Ivr {}

    class PDF extends \App\API\CustomPdf\LaravelPdf\Facades\Pdf {}
