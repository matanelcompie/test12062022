...
const TextInput = ({name, label, type, onChange, placeholder, value, error,errorMsg, onKeyDownEnter, bsFeedbackIcon, className,  disabled, required, isHorizontal, autoFocus, style}) => {
