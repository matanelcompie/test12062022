...
namespace App\API\CustomPdf\LaravelPdf;
...
class Pdf {
	...
	public function __construct($html = '', $config = [])
	{
		...
		$mpdf_config = [
			...
			'simpleTables'        =>   $this->getConfig('simpleTables'),      // simple the table (like no padding, color...)
			'useSubstitutions'        =>   $this->getConfig('useSubstitutions'),      // see https://mpdf.github.io/troubleshooting/slow.html
