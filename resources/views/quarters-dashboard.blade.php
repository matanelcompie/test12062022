...
<div id="app"></div>
<!-- Scripts -->
<script src="{{ URL::asset('js/quarters-dashboard.js', $secure) }}"></script>
<link rel="stylesheet" href="{{ URL::asset('css/quarters-dashboard.css', $secure) }}">
</body>
</html>
