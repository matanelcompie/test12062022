...
<html dir="rtl" lang="he">
    ...
    <body>
		...
		@foreach ($allBallotsData as $ballotRow)
        <div class="row">
            <div class="col-md-12">
                <div class="table-responsive">
				    <table style="font-size:18px;width:100%;">
						<tbody>
							...
							<th colspan="3" align="right">
									{{$ballotRow['electionRoleShiftsDetails'][0]}}
							</th>
							
							<th colspan="3" align="right">
									{{$ballotRow['electionRoleShiftsDetails'][1]}}
							</th>
							<th colspan="3" align="right">
									{{$ballotRow['electionRoleShiftsDetails'][2]}}
							</th>
							</tr>
							<tr>
							   ...
							   <td align="right" colspan="4" >
							     <strong>
							      טופס 1000 | קלפי
								  {{$ballotRow['ballotBoxFullStrExport']}}
								  </strong>
							   </td>
							...
							<tr class="headerStyle">
							   <td>עיר : 
								<strong>{{$ballotRow['cityName']}}</strong>
							   </td>
							   <td colspan="6" align="center">
							      אשכול : 
								  <strong>{{$ballotRow['clusterName']}}</strong>
							   </td>
							   <td colspan="2">כתובת : 
								<strong>{{$ballotRow['clusterAddress']}}</strong>
							   </td>
							</tr>
						...
						$numberOfCols = 25;
						$rowsCount = sizeof($ballotRow['ballotBoxVoters']);
						if($rowsCount >  500  ){
							if($rowsCount < 600){
								$numberOfCols = 30;
							}
                    ...
                    <table  style="width:100%;direction:ltr"  >
						...
						<tr> 
                            ...
                            @foreach ($ballotRow['ballotBoxVoters'] as $index => $row)
									<?php
									$className = 'pointed';
