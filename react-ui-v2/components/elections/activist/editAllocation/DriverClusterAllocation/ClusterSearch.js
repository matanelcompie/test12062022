...
class ClusterSearch extends React.Component {
    ...
    initConstants() {
        ...
        this.CollapseStyle={height: 'auto',overflow:'unset'};
    ...
    componentWillReceiveProps(nextProps) {
        let driverClusterAllocation = this.activistAllocationsTabs.driverClusterAllocation;
        if ( this.props.currentAllocationTab != driverClusterAllocation && nextProps.currentAllocationTab == driverClusterAllocation ) {
    ...
    searchClusters(event) {
        ...
        let roleIndex = this.props.activistDetails.election_roles_by_voter.findIndex(roleItem => roleItem.system_name == this.electionRoleSytemNames.driver);
        let electionRoleByVoterKey = this.props.activistDetails.election_roles_by_voter[roleIndex].key;
        ...
        ElectionsActions.driversClustersSearch(this.props.dispatch, electionRoleByVoterKey, searchObj);
    }
    ...
    changeCity(selectedItem, inputValue) {
        ...
        if ( selectedItem != null ) {
            ...
            ElectionsActions.loadActivistCityNeighborhoods(this.props.dispatch, selectedItem.key,
                ElectionsActions.ActionTypes.ACTIVIST.DRIVER.LOAD_NEIGHBORHOODS);
            ...
            ElectionsActions.loadActivistCityClusters(this.props.dispatch, selectedItem.key,
                ElectionsActions.ActionTypes.ACTIVIST.DRIVER.LOAD_CLUSTERS);
        } else {
            this.props.dispatch({type: ElectionsActions.ActionTypes.ACTIVIST.DRIVER.RESET_CLUSTERS});
    ...
    loadSubAreaCities(subAreaId) {
        let newCities = this.props.userFilteredCities.filter(cityItem => cityItem.sub_area_id == subAreaId);

        this.setState({citiesCombo: newCities});
    }
            ...
            <div className="containerStrip">
                ...
                <div className={"clusters-search" + (this.state.collapsed ? "" : " hidden")}>
                    <div className="row panelContent srchPanelLabel">
                        <div className="col-lg-3">
                                <div className="form-group">
                                    <label htmlFor="inputArea2-cluster-search-driver" className="control-label">אזור</label>
                                    <Combo items={this.props.userFilteredAreas}
                                           id="inputArea2-cluster-search-driver"
                                           maxDisplayItems={10}
                                           itemIdProperty="id"
                        ...
                        <div className="col-lg-3">
                                <div className="form-group">
                                    <label htmlFor="inputArea3-cluster-search-driver" className="control-label">תת אזור</label>
                                    <Combo items={this.state.combos.subAreas}
                                           id="inputSubArea2-cluster-search-driver"
                                           maxDisplayItems={10}
                                           itemIdProperty="id"
                                           itemDisplayProperty="name"
                                           className="form-combo-table"
                        ...
                        <div className="col-lg-3">
                                <div className="form-group">
                                    <label htmlFor="inputCity2-cluster-search-driver" className="control-label">עיר</label>
                                    <Combo items={this.state.combos.cities}
                                           id="inputCity2-cluster-search-driver"
                                           maxDisplayItems={10}
                                           itemIdProperty="id"
                                           itemDisplayProperty="name"
                                           className="form-combo-table"
                    ...
                    <div className="row panelContent srchPanelLabel">
                        <div className="col-lg-3">
                                <div className="form-group">
                                    <label htmlFor="inputBulk2-cluster-search-driver" className="control-label">אשכול</label>
                                    <Combo items={this.state.combos.clusters}
                                           id="inputBulk2-cluster-search-driver"
                                           maxDisplayItems={10}
                                           itemIdProperty="id"
                                           itemDisplayProperty="name"
                                           className="form-combo-table"
                        ...
                        <div className="col-lg-3">
                                <div className="form-group">
                                    <label htmlFor="inputBulk3-cluster-search-driver" className="control-label">סטטוס שיבוץ האשכול</label>
                                    <Combo items={this.assignmentStatusArr}
                                           id="inputBulk3-cluster-search-driver"
...
function mapStateToProps(state) {
    return {
        ...
        clusters: state.elections.activistsScreen.driver.combos.clusters,
        neighborhoods: state.elections.activistsScreen.driver.combos.neighborhoods,
