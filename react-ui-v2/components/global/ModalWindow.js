...
/**
 ...
 / ignoreOverflowSettings - if it's true - then ignore css settings on mount and unmound
...
class ModalWindow extends React.Component {
    ...
    componentWillUnmount() {
		...
		if(this.props.ignoreOverflowSettings){return;}
        if (this.props.show) {
    ...
    renderButtons() {
        ...
        if (this.props.buttons == undefined) {
            ...
            this.setButtonText();
            this.buttons = (
                <div className={"mwindow-buttons "+(this.props.buttonPosition?"position-"+this.props.buttonPosition:'')}>
