...
const DateInput = ({name, label, onChange, value, format, savingFormat, calendar, time, isRtl,
                    error, errorMsg, className, bsFeedbackIcon, disabled, readonly, required, isHorizontal}) => {
