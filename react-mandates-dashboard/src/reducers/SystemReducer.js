...
function systemReducer(state = { ...initState}, action) {
    ...
    switch (action.type) {
      ...
      case SystemActions.ActionTypes
        .LOADED_CURRENT_USER_GEOGRAPHIC_FILTERED_LISTS:
        newState.currentUserGeographicalFilteredLists = {
          ...newState.currentUserGeographicalFilteredLists,
        };
        newState.currentUserGeographicalFilteredLists.areas = action.data.areas;
        newState.currentUserGeographicalFilteredLists.sub_areas =
          action.data.sub_areas;
        newState.currentUserGeographicalFilteredLists.cities =
          action.data.cities;
        break;
      ...
      case ActionTypes.SET_DIRTY:
        ...
        if (
          newState.dirtyComponents.indexOf(action.target.toLowerCase()) == -1
        ) {
      ...
      case ActionTypes.CLEAR_DIRTY:
        if (action.target.toLowerCase() == "all") {
          ...
          newState.dirtyComponents = [...newState.dirtyComponents];
          let index = newState.dirtyComponents.indexOf(
      ...
      case ActionTypes.MENU.SEARCH_IN_MENU:
        ...
        newState.menus.menu = searchInMenu(
          newState.menus.openedMenuItems,
          newState.menus.menu,
          action.data
        );
        break;
      ...
      case ActionTypes.MENU.TOGGLE_MENU_ITEM:
        ...
        if (action.isOpen) {
          ...
          if (index > -1) newState.menus.openedMenuItems.splice(index, 1);
        } else {
      ...
      case ActionTypes.HEADER.OPEN_CHANGE_PASSWORD_MODAL:
        ...
        newState.userScreen.showHeaderChangePasswordModal = true;
        newState.userScreen.changePasswordModalOtherUser =
      ...
      case ActionTypes.HEADER.TOGGLE_LAST_VIEWED_VOTERS_MENU:
        newState.header = { ...newState.header };
        newState.header.lastViewedVotersMenuOpen =
          !newState.header.lastViewedVotersMenuOpen;
        break;
      ...
      case ActionTypes.HEADER.TOGGLE_FAVORITES_MENU:
        newState.header = { ...newState.header };
        newState.header.isFavoritesMenuOpen =
          !newState.header.isFavoritesMenuOpen;
        break;
      ...
      case ActionTypes.SET_HEADER_TITLE:
        newState.header.headerTitle = action.headerTitle;
        break;
